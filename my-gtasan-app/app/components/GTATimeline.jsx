            ...
            {timelineEvents.map((event, index) => (
              ...
              >
                ...
                <div className={`w-full md:w-1/2 ${
                  ...
                  <div className="p-4 sm:p-6 rounded-lg bg-gray-50 dark:bg-gray-900/30 border border-gray-200 dark:border-gray-800 hover:shadow-lg dark:hover:shadow-xl transition-all duration-300">
                ...
                <div className="hidden md:flex w-0 justify-center">
                  <div className="relative">
                    ...
                    {/* Main dot */}
                    <div className="w-8 h-8 rounded-full bg-gradient-to-r from-[#00ff87] to-[#00a2ff] border-4 border-white dark:border-[#030712] shadow-2xl z-10 relative"></div>
                  </div>
                </div>
                ...
                <div className="md:hidden absolute left-0 top-6">
                  <div className="relative">
                    ...
                    {/* Main dot */}
                    <div className="w-6 h-6 rounded-full bg-gradient-to-r from-[#00ff87] to-[#00a2ff] border-3 border-white dark:border-[#030712] shadow-2xl z-10 relative"></div>
                  </div>
                </div>
              </motion.div>
            ))}
