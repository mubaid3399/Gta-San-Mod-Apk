...
export default function GTAFeaturesDetail() {
 ...
 <div
 key={feature.id}
 className="p-6 rounded-lg bg-gray-900/30 border border-gray-800 hover:backdrop-blur-sm transition-all duration-300 hover:shadow-lg">
 ...
 <div className="relative h-80 rounded-xl overflow-hidden shadow-lg border border-gray-800">
 ...
 <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
 <div className="relative h-80 rounded-xl overflow-hidden shadow-lg border border-gray-800 order-2 lg:order-1">
 ...
 <div className="mt-8 p-6 rounded-xl bg-gray-900/30 border border-gray-800 w-full">
