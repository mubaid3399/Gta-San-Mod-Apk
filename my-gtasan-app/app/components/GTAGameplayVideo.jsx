...
export default function GTAGameplayVideo() {
 ...
 <div className="mt-8 p-6 rounded-xl bg-gray-900/40 border border-gray-700 w-full">
 ...
 <div className="p-6 rounded-lg bg-gray-900/30 border border-gray-800 transition-all duration-300">
