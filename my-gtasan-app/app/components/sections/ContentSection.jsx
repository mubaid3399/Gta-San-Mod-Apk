...
export default function ContentSection({
  ...
  return (
    <ScrollRevealWrapper animation="fade-in-up" duration={800}>
      <section
        id={id}
        className={`relative w-full ${bgColorMap[bgColor]} text-gray-900 dark:text-gray-100 py-20 px-4 sm:px-6 lg:px-8`}
      >
        <div className="container mx-auto max-w-4xl">
          ...
          {(title || subtitle || description) && (
            ...
            >
              ...
              {subtitle && (
                <h3 className="text-xl sm:text-2xl font-bold mb-6 text-gray-700 dark:text-gray-300">
                  {subtitle}
                </h3>
              )}
