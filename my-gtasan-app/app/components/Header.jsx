...
function Header() {
 ...
 >
 <button className="backdrop-blur-md bg-black/10 border border-gray-300 rounded-full cursor-pointer px-3 py-2 flex items-center gap-2 text-white hover:bg-black/20 transition-all/10">
 ...
 {/* Dropdown Menu */}
 <div
 className={`absolute right-0 mt-2 w-48 bg-gray-900/95 border border-gray-300 rounded-xl shadow-2xl transition-all duration-200 z-50 ${
 ...
 className={`w-full text-left px-4 py-3 transition-all cursor-pointer first:rounded-t-xl last:rounded-b-xl ${
 ...
 {/* Sidebar Menu */}
 <motion.div
 className="absolute left-0 top-0 bottom-0 w-64 bg-[#030712] border-r border-white/10 shadow-2xl"
 initial={{ x: -256 }}
 animate={{ x: 0 }}
 exit={{ x: -256 }}
