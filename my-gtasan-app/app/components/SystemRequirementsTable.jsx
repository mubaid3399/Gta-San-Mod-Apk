  ...
  return (
    <section className="relative w-full bg-white dark:bg-[#030712] text-gray-900 dark:text-gray-100 py-20 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto max-w-6xl">
              ...
              {requirementsData.map((item, index) => (
                <tr
                  ...
                  className={`border-b border-gray-200 dark:border-gray-800 transition-all duration-300 ${
                    index % 2 === 0
                      ? 'bg-white dark:bg-gray-950/30 hover:bg-white/60 dark:hover:bg-gray-900/50 hover:backdrop-blur-sm dark:hover:backdrop-blur-sm hover:shadow-lg dark:hover:shadow-xl'
        ...
        {/* Additional Info */}
        <div className="mt-12 p-6 rounded-xl bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800">
