...
export default function FAQSection({ faqs: customFAQs = null }) {
 ...
 <>
 <style>{styles}</style>
 <section className="relative w-full bg-gradient-to-b from-gray-900/50 to-[#030712] text-white py-20 px-4 sm:px-6 lg:px-8">
 ...
 <div
 key={faq.id}
 className="group rounded-lg overflow-hidden bg-gray-900/40 border border-gray-800 hover:border-[#00ff87]/50 transition-all duration-300 hover:shadow-lg">
 {/* Question */}
 <button
 onClick={() => toggleAccordion(index)}
 className="w-full px-6 sm:px-8 py-5 sm:py-6 flex items-start sm:items-center justify-between gap-4 text-left transition-colors duration-200"
 >
 ...
 {/* Question Text */}
 <span className="text-base sm:text-lg font-semibold text-white leading-snug pt-1">
 {faq.question}
 </span>
 </div>
 {/* Chevron Icon */}
 ...
 >
 <div className="px-6 sm:px-8 pb-5 sm:pb-6 pt-4 sm:pt-5 border-t border-gray-800 bg-gradient-to-b from-transparent to-gray-50/50">
 ...
 {/* Additional Info */}
 <div className="mt-12 sm:mt-16 p-6 sm:p-8 rounded-lg bg-gray-900/30 border border-gray-800">
 <h4 className="text-base sm:text-lg font-semibold text-[#00ff87] mb-3">
