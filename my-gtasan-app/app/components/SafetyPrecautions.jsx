      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          {precautions.map((precaution) => (
            <div
              key={precaution.id}
              className="group p-6 rounded-lg bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 border border-blue-200 dark:border-blue-800 hover:shadow-lg dark:hover:shadow-xl hover:border-blue-400 dark:hover:border-blue-600 transition-all duration-300 overflow-hidden"
            >
              {/* Number Badge */}
              <div className="flex items-start gap-4 min-w-0">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-r from-[#00ff87] to-[#00a2ff] group-hover:shadow-lg group-hover:shadow-[#00ff87]/50 transition-all duration-300">
                    <span className="font-bold text-black text-lg">{precaution.number}</span>
                  </div>
                </div>
                ...
                <div className="flex-grow min-w-0">
                  <div className="flex items-start gap-2 mb-2 flex-wrap">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white group-hover:text-[#00ff87] transition-colors duration-300 break-words">
                      {precaution.title}
                    </h3>
                  </div>
        ...
        {/* Important Note */}
        <div className="bg-amber-50 dark:bg-amber-950/20 border-l-4 border-amber-400 dark:border-amber-600 rounded-r-lg p-6 sm:p-8 overflow-hidden">
          <h3 className="text-lg sm:text-xl font-bold text-amber-900 dark:text-amber-300 mb-3 flex items-center gap-2 break-words">
            <span className="text-2xl flex-shrink-0">⚠️</span>
            <span>{t('safety.importantNote')}</span>
          </h3>
          <p className="text-amber-800 dark:text-amber-200 text-sm sm:text-base leading-relaxed break-words">
