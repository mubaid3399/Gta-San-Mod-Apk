...
export default function ComparisonSection() {
  ...
  return (
    <section className="relative w-full bg-gray-900 dark:bg-[#030712] text-white dark:text-gray-100 py-20 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto max-w-6xl">
          ...
          <table className="w-full min-w-full">
            ...
            <tbody>
              {comparisonData.map((item, index) => (
                <tr
                  key={item.id}
                  className={`border-b border-gray-800 dark:border-gray-800 hover:bg-gray-800 dark:hover:bg-gray-900/30 transition-colors duration-300 ${
        ...
        <div className="bg-blue-900/40 dark:bg-blue-950/20 border border-blue-800 dark:border-blue-800 rounded-xl p-6 sm:p-8">
          <h3 className="text-lg sm:text-xl font-bold text-white dark:text-white mb-4 flex items-center gap-2">
            <span className="text-2xl">💡</span>
            {t('comparison.personalNote')}
          </h3>
          <p className="text-gray-300 dark:text-gray-300 leading-relaxed text-sm sm:text-base">
