...
export default function DownloadInstallation() {
  ...
  return (
    <section className="relative w-full bg-gradient-to-b from-white to-gray-100 dark:from-[#030712] dark:to-gray-900/50 text-white dark:text-gray-100 py-20 px-4 sm:px-6 lg:px-8">
  <div className="container mx-auto max-w-6xl">
    {/* Section Header */}
    <div className="mb-16 text-center">
      <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-6 text-white dark:text-white">
    ...
    <div className="mb-20">
      <div className="space-y-6">
        {steps.map((step, index) => (
          <div
            key={index}
            className="flex flex-col sm:flex-row gap-4 sm:gap-6 group hover:bg-gray-800 dark:hover:bg-gray-900/50 p-4 sm:p-6 rounded-lg transition-all duration-300 bg-gray-900/50 dark:bg-gray-900/50"
          >
            ...
            <div className="flex-grow">
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white dark:text-white mb-2 group-hover:text-[#00ff87] transition-colors duration-300">
                {step.title}
              </h3>
    ...
    {/* Tips Section */}
    <div className="bg-gray-900/50 dark:bg-gray-900/30 border border-gray-800 dark:border-gray-800 rounded-xl p-4 sm:p-8 lg:p-10 mb-12">
      <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white dark:text-white mb-6 sm:mb-8 text-center">
        {t('downloadInstallation.tipsSection.title')}
      </h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        {tips.map((tip, index) => (
          <div key={index} className="flex gap-3 sm:gap-4 p-3 sm:p-4 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-800 transition-colors duration-300 bg-gray-800/50 dark:bg-gray-800/50">
            <div className="flex-shrink-0">
            ...
            <div className="flex-grow">
              <h4 className="text-sm sm:text-base font-bold text-white dark:text-white mb-1">
                {tip.title}
              </h4>
